...
class BotSettings extends Model
{
    ...
    protected $fillable = [
        ...
        'copier_protect_at_r', 'copier_breakeven', 'copier_breakeven_offset_pips',
    ...
    protected function casts(): array
    {
        return [
            ...
            'ai_autonomous_symbols' => 'array',
            'copier_protect_at_r' => 'float',
            'copier_breakeven' => 'boolean',
            'copier_breakeven_offset_pips' => 'float',
